...
public class SdxRepairTests extends PreconditionSdxE2ETest {
    ...
    public void testSDXMultiRepairIDBRokerAndMasterWithTerminatedEC2Instances(TestContext testContext) {
        ...
        testContext
                ...
                .then((tc, testDto, client) -> {
                    waitUtil.waitForSdxInstanceStatus(testDto.getResponse().getName(), client, getSdxInstancesDeletedOnProviderSideState());
                    return testDto;
                })
    ...
    public void testSDXRepairIDBRokerWithStoppedEC2Instance(TestContext testContext) {
        ...
        testContext
                ...
                .then((tc, testDto, client) -> {
                    waitUtil.waitForSdxInstanceStatus(testDto.getResponse().getName(), client, Map.of(IDBROKER.getName(), InstanceStatus.STOPPED));
                    return testDto;
                })
                .when(sdxTestClient.repair(), key(sdx))
                .await(SdxClusterStatusResponse.REPAIR_IN_PROGRESS, key(sdx))
    ...
    public void testSDXRepairMasterWithStoppedEC2Instance(TestContext testContext) {
        ...
        testContext
                ...
                .then((tc, testDto, client) -> {
                    waitUtil.waitForSdxInstanceStatus(testDto.getResponse().getName(), client, Map.of(MASTER.getName(), InstanceStatus.STOPPED));
                    return testDto;
                })
                .when(sdxTestClient.repair(), key(sdx))
                .await(SdxClusterStatusResponse.REPAIR_IN_PROGRESS, key(sdx))
